...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5">
                <div class="card-header pb-0 text-center" style="background: lightgrey;"><h5><b>Only Admin</b></h5></div>
                ...
                <div class="card-body" style="background: lightgrey;">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right"><h6 style="color: black;">Password</h6></label>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember">
                                        <h6 style="color: black;">Remember Me</h6>
                                    </label>
                                </div>
                            </div>
                        </div>
